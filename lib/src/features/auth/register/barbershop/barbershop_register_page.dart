...
import 'package:jgs_barbershop/src/features/auth/register/barbershop/barbershop_register_state.dart';
import 'package:jgs_barbershop/src/features/auth/register/barbershop/barbershop_register_vm.dart';
    ...
    ref.listen(barbershopRegisterVmProvider, (_, state) {
      switch (state.status) {
        ...
        case BarbershopRegisterStateStatus.error:
          Messages.showError(
            'Desculpe ocorreu um erro ao registrar uma barbearia',
            context,
          );
          break;
